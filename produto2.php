...
<button id="toggle-dark-mode" class="modo-toggle">
  ...
  <div style="max-width: 900px; margin: 0 auto; text-align: center;">
    <h2 style="font-size: 2rem; margin-bottom: 20px;">Cartilha de Segurança na Internet</h2>
    ...
    <a href="download_cartilha.php" target="_blank" style="display: inline-block; margin: 20px 0; padding: 12px 24px; background-color: #007bff; color: #fff; border-radius: 8px; text-decoration: none; font-weight: bold;">
...
echo "<p style='margin-top: 10px; color: #555; font-size: 1rem;'>🔽 A cartilha já foi baixada <strong>$downloads</strong> vezes.</p>";
?>
