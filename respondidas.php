...
// Voltar mensagem para não respondida
...
<head>
    ...
    <style>
        /* Copie o CSS do admin.php para manter padrão */
        body {
...
<form class="busca" method="GET" action="respondidas.php">
    ...
    <tbody>
        <?php while ($linha = $resultado->fetch_assoc()) : ?>
            <tr>
                ...
                <td>
                    <div class="acoes">
                        <a href="respondidas.php?retornar=<?= $linha['id'] ?>" class="retornar" onclick="return confirm('Marcar como não respondida?')">Não lida</a>
                        <span>|</span>
